...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-group input, .form-group textarea { width: 100%; padding: 14px 16px; border: 1px solid #e9ecef; border-radius: 8px; font-size: 15px; font-family: 'DM Sans', sans-serif; transition: all 0.3s; }
        .form-group input:focus, .form-group textarea:focus { outline: none; border-color: #e94560; box-shadow: 0 0 0 3px rgba(233,69,96,0.1); }
    ...
    <div class="container">
        <div class="panel">
            ...
            <form action="${pageContext.request.contextPath}/board/create" method="post">
                ...
                <div class="form-group">
                    <label>板块描述</label>
                    <textarea name="description" rows="4" placeholder="请输入板块描述"></textarea>
                </div>
                <div class="form-actions">
                    <button type="submit" class="btn-primary">创建</button>
                    <a href="${pageContext.request.contextPath}/" class="btn-secondary">取消</a>
                </div>
            </form>
        </div>
    </div>
